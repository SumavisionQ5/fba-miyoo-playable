...
depobj	+=	\
		...
		x1010.o \
		\
		i8039.o m6502.o m6502_intf.o sh2.o z80.o z80daisy.o cz80.o \
		\
...
allobj += $(assemdir)cpu/drz80/DrZ80.o
allobj += $(assemdir)cpu/cyclone/cyclone.o
allobj += $(assemdir)cpu/armnec/armV33.o
allobj += $(assemdir)cpu/armnec/armV30.o
